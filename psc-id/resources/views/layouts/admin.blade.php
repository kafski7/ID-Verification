    ...
    <aside class="hidden md:flex md:flex-col md:w-64 bg-gray-900 text-white">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 text-sm">
            ...
            <a href="{{ route('admin.admin-users.index') }}"
               class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.admin-users.*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition">
                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
