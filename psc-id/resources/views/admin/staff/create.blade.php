<x-layouts.admin heading="Add Staff Member">
        ...
        <form method="POST" action="{{ route('admin.staff.store') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="date" name="card_expires" value="{{ old('card_expires') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Photo <span class="text-gray-400 font-normal">(JPG/PNG, max 2 MB)</span></label>
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('admin.staff.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
            </div>
        </form>
    </div>
